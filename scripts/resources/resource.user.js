...
(function () {
    var interval1 = new Date();
    console.log(interval1);
    console.log(interval1.getMilliseconds());
    ...
    if ( location.href.indexOf('/game/index.php?page=resourceSettings') != -1 ) {
        ...
        if ( numPlanets > 0 ) {
            ...
            divRecursos.style.width = '96%';
            divRecursos.style.margin = '0 auto';
